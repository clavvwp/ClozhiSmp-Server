...
const TOP_PLAYERS = [
  ...
  { rank: 9, name: 'Hans',   achievement: 'Top Builder Thinker',   icon: '🌟', detail: 'Solo speedrun' },
  { rank: 10, name: 'David',   achievement: 'Top Player terbarbar',   icon: '🌟', detail: 'Solo speedrun' },
];
