...
const ADMINS = [
  {
    ...
    socials: { discord: 'Clazyx', ig: '@clav.vwp' },
    joinDate: 'Founder',
    badge: '♛',
  },
  {
  ...
  },
  {
    ...
    description: 'Termasuk pendiri ClozhiSmp pada saat S1, Ikky adalah admin yang menjaga komunitas tetap ramah dan aktif. walaupun dia suka lupa',
    socials: { discord: 'typtype122', ig: '@Forgetfulikky2006' },
    joinDate: 'Season 1',
    badge: '⚒',
  },
  {
    ...
    roleColor: '#f97316',
    skinUrl: '',
    description: 'Termasuk pendiri ClozhiSmp S1, Zhafran adalah otak di balik banyak ide kreatif server.',
    socials: { discord: 'Zhafyx24', ig: '-' },
    joinDate: 'Season 1',
    badge: '🏗️',
  },
  {
    ...
    role: 'Co-Operator',
    roleColor: '#2cff4b',
    skinUrl: '/admins/Cae.png',
    description: 'Co-Operator yang membantu mengelola server dan memastikan semuanya berjalan lancar.',
    socials: { discord: 'only2me2', ig: '-' },
    joinDate: 'Season 2',
    badge: '𖦹',
  },
];
